...
class CrimeEvidenceDTOBuilderTest {
    ...
    void givenApiCalculateEvidenceFeeRequest_whenBuildIsInvoked_thenCorrectCrimeEvidenceDTOFieldsArePopulated() {
        CrimeEvidenceDTO crimeEvidenceDTO =
                CrimeEvidenceDTOBuilder.build(TestModelDataBuilder.getApiCalculateEvidenceFeeRequest(Boolean.TRUE));
        ...
        softly.assertThat(crimeEvidenceDTO.getEvidenceFee().getFeeLevel())
                .isEqualTo(EvidenceFeeLevel.LEVEL1.getFeeLevel());
        softly.assertThat(crimeEvidenceDTO.getEvidenceFee().getDescription())
                .isEqualTo(EvidenceFeeLevel.LEVEL1.getDescription());
        softly.assertThat(crimeEvidenceDTO.getCapitalEvidenceReceivedDate())
                .isEqualTo(TestModelDataBuilder.CAPITAL_EVIDENCE_RECEIVED_DATE);
        softly.assertThat(crimeEvidenceDTO.getIncomeEvidenceReceivedDate())
                .isEqualTo(TestModelDataBuilder.INCOME_EVIDENCE_RECEIVED_DATE);
        ...
        softly.assertThat(capitalEvidenceList.get(0).getDateReceived())
                .isEqualTo(TestModelDataBuilder.CAPITAL_EVIDENCE_RECEIVED_DATE);
        softly.assertThat(capitalEvidenceList.get(1).getEvidenceType()).isEqualTo("MOCK_TEST1");
        softly.assertThat(capitalEvidenceList.get(1).getDateReceived())
                .isEqualTo(TestModelDataBuilder.INCOME_EVIDENCE_RECEIVED_DATE);
        softly.assertAll();
    }
}
