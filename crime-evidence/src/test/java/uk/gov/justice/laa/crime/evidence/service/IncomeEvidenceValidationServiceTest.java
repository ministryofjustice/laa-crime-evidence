...
class IncomeEvidenceValidationServiceTest {
    ...
    @Test
    void
            givenValidDates_whenCheckEvidenceReceivedDateIsInvokedWithIncomeEvidenceReceivedDateNull_thenNoExceptionIsThrown() {
        incomeEvidenceValidationService.checkEvidenceReceivedDate(null, LocalDate.now());
    }

    @Test
    void
            givenValidDates_whenCheckEvidenceReceivedDateIsInvokedWithIncomeEvidenceReceivedDateAfterCurrentDate_thenExceptionIsThrown() {
        LocalDate futureDate = LocalDate.now().plusMonths(2);
        LocalDate currentDate = LocalDate.now();
        assertThrows(
                CrimeEvidenceDataException.class,
                () -> incomeEvidenceValidationService.checkEvidenceReceivedDate(futureDate, currentDate));
    }

    @Test
    void
            givenValidDates_whenCheckEvidenceReceivedDateIsInvokedWithIncomeEvidenceReceivedDateBeforeCurrentDate_thenExceptionIsThrown() {
    ...
    @Test
    void
            givenValidDates_whenCheckEvidenceDueDatesIsInvokedWithEvidenceDueDateNullAndEvidencePending_thenExceptionIsThrown() {
        LocalDate currentDate = LocalDate.now();
        assertThrows(
                CrimeEvidenceDataException.class,
    ...
    @Test
    void
            givenValidDates_whenCheckEvidenceDueDatesIsInvokedWithEvidenceDueDateAfterCurrentDate_thenNoExceptionIsThrown() {
        LocalDate futureDate = LocalDate.now().plusMonths(2);
        LocalDate currentDate = LocalDate.now();
    ...
    @Test
    void
            givenValidDates_whenCheckEvidenceDueDatesIsInvokedWithEvidenceDueDateBeforeCurrentDate_thenExceptionIsThrown() {
        LocalDate pastDate = LocalDate.now().minusMonths(2);
    ...
    @Test
    void
            givenValidDates_whenCheckEvidenceDueDatesIsInvokedWithExistingEvidenceDueDateAsNullAndEvidenceDueDateAfterDate_thenNoExceptionIsThrown() {
        LocalDate futureDate = LocalDate.now().plusMonths(2);
        LocalDate currentDate1 = LocalDate.now();
    ...
    @Test
    void
            givenValidDates_whenCheckEvidenceDueDatesIsInvokedWithExistingEvidenceDueDateAsNullAndEvidenceDueDateAsNull_thenNoExceptionIsThrown() {
        LocalDate currentDate1 = LocalDate.now();
    ...
    @Test
    void
            givenValidDates_whenCheckEvidenceDueDatesIsInvokedWithExistingEvidenceDueDateBeforeCurrentDate_thenNoExceptionIsThrown() {
        LocalDate currentDate1 = LocalDate.now();
    ...
    @Test
    void
            givenIncomeExtraEvidenceWithEmptyDescription_whenCheckExtraEvidenceDescriptionsIsInvoked_thenExceptionIsThrown() {
    ...
    void testValidateUpliftDatesExceptions(
            UpdateEvidenceDTO updateEvidenceDTO, boolean allEvidenceReceived, String message) {
        assertThatThrownBy(() ->
                        incomeEvidenceValidationService.validateUpliftDates(updateEvidenceDTO, allEvidenceReceived))
                .isInstanceOf(CrimeEvidenceDataException.class)
                .hasMessage(message);
    }
    ...
    public static Stream<Arguments> validateUpliftDates() {
        ...
        return Stream.of(
                Arguments.of(
                        UpdateEvidenceDTO.builder().upliftRemovedDate(today).build(),
                        true,
                        CANNOT_SET_UPLIFT_REMOVED_DATE_WHEN_NO_UPLIFT_APPLIED),
                Arguments.of(
                        UpdateEvidenceDTO.builder()
                                .upliftRemovedDate(yesterday)
                                .oldUpliftAppliedDate(lastMonth)
                                .oldUpliftRemovedDate(lastMonth)
                                .build(),
                        true,
                ...
                Arguments.of(
                        UpdateEvidenceDTO.builder().upliftAppliedDate(today).build(),
                        true,
                        CANNOT_APPLY_UPLIFT_IF_NO_OUTSTANDING_EVIDENCE_REQUIRED),
                Arguments.of(
                        UpdateEvidenceDTO.builder().upliftAppliedDate(yesterday).build(),
                        false,
