...
public class UpdateEvidenceDTOBuilder {
    ...
    public static UpdateEvidenceDTO build(final ApiUpdateIncomeEvidenceRequest request) {
        return UpdateEvidenceDTO.builder()
                ...
                .applicantDetails(
                        request.getApplicantEvidenceItems() != null
                                ? request.getApplicantEvidenceItems().getApplicantDetails()
                                : null)
                ...
                .partnerDetails(
                        request.getPartnerEvidenceItems() != null
                                ? request.getPartnerEvidenceItems().getApplicantDetails()
                                : null)
                ...
                .applicantIncomeEvidenceItems(
                        request.getApplicantEvidenceItems() != null
                                ? request.getApplicantEvidenceItems().getIncomeEvidenceItems()
                                : null)
                .partnerIncomeEvidenceItems(
                        request.getPartnerEvidenceItems() != null
                                ? request.getPartnerEvidenceItems().getIncomeEvidenceItems()
                                : null)
