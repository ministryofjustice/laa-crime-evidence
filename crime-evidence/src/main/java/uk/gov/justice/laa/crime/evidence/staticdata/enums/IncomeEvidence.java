...
public enum IncomeEvidence {
    ...
    WAGE_SLIP_ADHOC(
            "WAGE SLIP ADHOC",
            "Wage Slip",
            "Wage Slip within past 3 months",
            "Papur Cyflog o fewn y tri mis diwethaf",
            "Y"),
    ...
    OTHER_BUSINESS(
            "OTHER BUSINESS", "Other Business Records", "Other Business Records", "Cofnodion Busnes eraill", "N"),
    CASH_BOOK("CASH BOOK", "Cash Book", "Cash Book", "Llyfr Arian", "N"),
    WAGE_SLIP(
            "WAGE SLIP", "Wage Slip", "Wage Slip within past 3 months", "Papur Cyflog o fewn y tri mis diwethaf", "N"),
    ...
    public static IncomeEvidence getFrom(String type) {
        ...
        return Stream.of(IncomeEvidence.values())
                ...
                .findFirst()
                .orElseThrow(() ->
                        new IllegalArgumentException(String.format("Income evidence : %s does not exist.", type)));
    }
}
