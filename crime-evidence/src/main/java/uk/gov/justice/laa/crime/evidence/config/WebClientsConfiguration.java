...
public class WebClientsConfiguration {
    ...
    WebClient maatCourtDataWebClient(WebClient.Builder webClientBuilder,
        ...
        Resilience4jRetryFilter retryFilter = new Resilience4jRetryFilter(retryRegistry, COURT_DATA_API_WEB_CLIENT_NAME);
    ...
    @Bean
    MaatCourtDataApiClient maatCourtDataApiClient(@Qualifier(COURT_DATA_API_WEB_CLIENT_NAME) WebClient maatCourtDataWebClient) {
